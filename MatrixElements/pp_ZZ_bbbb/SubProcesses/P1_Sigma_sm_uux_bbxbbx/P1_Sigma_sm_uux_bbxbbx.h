...
class P1_Sigma_sm_uux_bbxbbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_uux_bbxbbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_uux_bbxbbx() {}; 
  ...
  private:
    ...
    // Matrix elements
    double matrix_1_uux_zz_z_bbx_z_bbx(); 
    double matrix_1_ddx_zz_z_bbx_z_bbx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_uux_bbxbbx >> > mapFinalStates;
